========================================================================
    ACTIVE TEMPLATE LIBRARY : WMPRemote Project Overview
========================================================================

AppWizard has created this WMPRemote project for you to use as the starting point for
...
WMPRemote.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (WMPRemote.h)
        GUID definitions                                (WMPRemote_i.c)
        A type library                                  (WMPRemote.tlb)
        Marshaling code                                 (WMPRemote_p.c and dlldata.c)

WMPRemote.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in WMPRemote.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named WMPRemote.pch and a precompiled types file named StdAfx.obj.
...
WMPRemoteps.vcxproj
	...
	dlldata.c, WMPRemote_i.c and WMPRemote_p.c which are required
	to build the proxy/stub DLL.

WMPRemoteps.vcxproj.filters
